...
function eliminar(event){
    ...
    btnConfirmarDelete.addEventListener("click",function(event){
        event.preventDefault()
        let urlDelete = "http://localhost:3000/api/usuarios/"+idActual
...
function editar(event){
    ...
    console.log(event.currentTarget.parentElement.previousElementSibling + "ElementSibling");
   ...
   btnEditar.addEventListener("click",function(event){
    ...
    let urlEditar = "http://localhost:3000/api/usuarios/"+idActual
    fetch(urlEditar, {
        method : 'PUT',
        body:[datosJSON],
        headers:{
